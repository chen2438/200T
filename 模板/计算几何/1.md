...
namespace geometry{
    ...
    struct PT {
        ...
        PT operator*(const int k) {return PT(x*k,y*k);}
        ...
        void rotate(double angle){//顺时针旋转angle弧度
    ...
    double dot(PT a, PT b) {return a.x*b.x+a.y*b.y;}//点乘
    double cross(PT a,PT b){return a.x*b.y-b.x*a.y;}//叉乘
    //A与B张成的平行四边形的有向面积,B在A的逆时针方向为正
